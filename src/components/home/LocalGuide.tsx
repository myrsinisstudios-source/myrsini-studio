        ...
        >
          {filtered.map(poi => (
            <a
              ...
              className="shrink-0 w-48 sm:w-56 bg-white border border-deep-wood/8 rounded-xl p-4 hover:border-olive/40 hover:shadow-md transition-all snap-start group"
            >
              {/* Icon header */}
